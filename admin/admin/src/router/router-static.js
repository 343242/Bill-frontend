...
import adminexam from '@/views/modules/exampaperlist/exam'
    ...
    import paiBanGuiZe from '@/views/modules/paiBanGuiZe/list'
    import shouYeXinXi from '@/views/modules/shouYeXinXi/list'
    import shipinpinglun from '@/views/modules/shipinpinglun/list'
    import xiTongCanShu from '@/views/modules/xiTongCanShu/list'
    import riZhi from '@/views/modules/riZhi/list'
    import storeup from '@/views/modules/storeup/list'
    import cuotiban from '@/views/modules/cuotiban/list'
...
const routes = [{
	...
	path: '/paiBanGuiZe',
        name: '排课规则',
        component: paiBanGuiZe
      }
      ,{
	path: '/shouYeXinXi',
        name: '首页信息',
        component: shouYeXinXi
      }
      ,{
	path: '/shipinpinglun',
        name: '视频评论管理',
        component: shipinpinglun
      }
      ,{
	path: '/xiTongCanShu',
        name: '系统参数',
        component: xiTongCanShu
      }
      ,{
    path: '/riZhi',
        name: '系统日志',
