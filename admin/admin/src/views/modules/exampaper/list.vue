...
export default {
  ...
  methods: {
    ...
    exam(id) {
      ...
      // 移除可能存在的引号
      sessionTable = sessionTable.replace(/"/g, '');
      token = token.replace(/"/g, '');
      
      // 在当前窗口中打开考试页面，将必要的参数作为URL参数传递
      let examUrl = '/springbooto2ehg/front/front/pages/exampaper/exam.html?id=' + id + '&userTable=' + sessionTable + '&token=' + token;
